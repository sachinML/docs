...
@[RecursiveCharacterTextSplitter] includes pre-built lists of separators that are useful for [splitting text](/oss/python/integrations/splitters/) in a specific programming language.
