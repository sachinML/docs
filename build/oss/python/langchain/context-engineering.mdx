...
Reference these files when answering questions."""
            ...
            request.messages = [
                request.messages[0],  # System message
                {"role": "user", "content": file_context},
                *request.messages[1:]  # Rest of conversation
            ]
...
[Middleware](/oss/python/langchain/middleware) provides hooks that run between model calls and tool execution, with three key capabilities:
