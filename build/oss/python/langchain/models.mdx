...
<Info>
    For provider-specific integration information and capabilities, see the provider's [integration page](/oss/python/integrations/providers/overview).
</Info>
...
The easiest way to get started with a standalone model in LangChain is to use [`init_chat_model`](https://reference.langchain.com/python/langchain/models/#langchain.chat_models.init_chat_model) to initialize one from a [provider](/oss/python/integrations/providers/overview) of your choice (examples below):
