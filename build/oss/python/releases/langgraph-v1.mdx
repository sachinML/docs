...
* For information on the new `create_agent` API, see the [LangChain v1 release notes](/oss/python/releases/langchain-v1#create-agent).
* For information on migrating from `create_react_agent` to `create_agent`, see the [LangChain v1 migration guide](/oss/python/migrate/langchain-v1#create-agent).
