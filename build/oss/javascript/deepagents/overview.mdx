...
For simpler use cases, consider using [LangChain's create_agent](/oss/javascript/langchain/agents) or building a custom [LangGraph](/oss/javascript/langgraph/overview) workflow.
...
Deep agents applications can be deployed on [LangGraph Platform](/oss/javascript/langgraph/deploy) and monitored with [LangSmith](/langsmith/observability).
