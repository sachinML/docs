...
<div class="mx-auto max-w-8xl px-0 lg:px-5" style={{ paddingBottom: "8rem" }}>
    <div class="mdx-content prose prose-gray dark:prose-invert mx-4 pt-10">
        ...
        <Callout icon="bullhorn" color="#4F46E5" iconType="regular">
        LangGraph Platform is now part of [LangSmith](/langsmith/home). For more information, check out the [Changelog](https://changelog.langchain.com/announcements/product-naming-changes-langsmith-deployment-and-langsmith-studio).
        </Callout>
...
<div className="relative">
    <div className="absolute top-0 left-0 w-screen h-48 dark:bg-background-dark z-10">
    </div>
</div>
